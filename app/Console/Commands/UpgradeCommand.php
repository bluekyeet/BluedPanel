...
{
    protected const DEFAULT_URL = 'https://github.com/bluekyeet/BluedPanel/releases/download/refs%2Fheads%2Fmain/panel.tar.gz';
    ...
    /** @var string */
    protected $description = 'Downloads a new archive for BluedPanel from GitHub and then executes the normal upgrade commands.';
